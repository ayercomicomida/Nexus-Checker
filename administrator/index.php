<?php session_start(); 
    ...
    if ($_SESSION['plan'] != 'admin') {
        header('Location: ../panel?error=no_permission');
        exit();
    }
    ...
    <?php
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if ($response === false) {
                ...
                if (isset($response_data['message']) && $response_data['message'] == 'Usuário registrado com sucesso!') {
            ...
            <div class="md:pl-28 py-2 h-fit md:py-18 grow w-full">
                <main class="container">
                    ...
                    <div role="alert"
                        ...
                        <h5 class="mb-1 font-medium leading-none tracking-tight">Aviso para Administradores:</h5>
                        <div class="text-sm [&amp;_p]:leading-relaxed">Ao adicionar um novo usuário, por favor, verifique as seguintes informações:

Username: Certifique-se de que o nome do usuário está correto.
Plan: Assegure-se de que as permissões atribuídas ao usuário estão corretas e de acordo com suas funções.
Nota: Uma vez criado, o usuário terá acesso aos recursos conforme as permissões atribuídas. Revise as configurações antes de finalizar.</div>
                    </div>
                    <div class="rounded-lg border bg-card text-card-foreground shadow-sm">
                        ...
                        <div class="flex flex-col space-y-1.5 p-6">
                            <h2 class="text-2xl font-semibold leading-none tracking-tight flex justify-between"><span
                                    class="text-foreground w-full max-w-sm break-words text-2xl md:max-w-none">Bem-vindo(a) <?php echo $_SESSION['username']; ?></span>
                                    
                        </div>
                        
                        <div class="p-6 pt-0 -mt-2 leading-loose">
                        <p class="text-sm text-muted-foreground flex flex-col gap-2">
                        <span class="font-medium sm:font-bold">Sobre o Plan :</span>
                        <span
                                    class="text-monochrome/60"><span class="text-yellow-500">vip</span><span> : </span><span
                                        class="font-medium sm:font-bold">VIPs tem acesso a APIs para VIPs</span></span>
                        <span class="text-monochrome/60" ><span class="text-red-500">admin</span><span> : </span><span
                                        class="font-medium sm:font-bold">ADMs tem acesso a todos os recursos do site</span></span>
                                        <span
                                    class="text-monochrome/60"><span class="text-green-500">extreme</span><span> : </span><span
                                        class="font-medium sm:font-bold">EXTREME tem acesso a todas as APIs</span></span>
                    </div>
                    </div>
                    <div class="rounded-lg border bg-card text-card-foreground shadow-sm">
                        </div>
                        ...
                        <form method="post" class="login-form">
                            <input type="text" name="plan" placeholder="plan (exemple: extreme / admin / vip)">
                            <input type="text" name="expiration_date" placeholder="data (exemple: ano-mes-dia)">
                            <input type="text" name="username" placeholder="username">
                            <input type="password" name="password" placeholder="password">
                            <input type="submit" name="REQUEST_METHOD" value="Register">
                        </form>
                </main>
            </div>
